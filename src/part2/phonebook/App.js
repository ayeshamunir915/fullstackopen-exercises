...
//   .then((response) => {
//     const allPersons = response.data.persons.allPersons;
...
//     }
//     axios
//     .post('http://localhost:3000/', newPhonebookObject)
//     .then(response => {
...
//     }
//     newPhonebookObject
//     .update(id, newPhone).then(returnedPerson => {
...
//       newPhonebookObject.deleteName(id)
//     }
//   }
...
//        <PersonForm onSubmit={addNewPerson} newName={newName} setNewName={setNewName} newPhone={newPhone} setNewPhone={setNewPhone} />
//       <h3>Numbers</h3>
//      <Persons persons={persons} number={newPhone} addNewName={addNewPerson} deleteName={deleteName}/>
//     </div>
//   )
// }
...
//       (window.alert(`${newName} is already added to phonebook`))
//     }
//     const replacePhone = persons.find(persons => persons.name === newName)[0].id
//     if (replacePhone) {
